...
const allProjects = [{
    id: 1,
    title: 'Inteligentny sad',
    image: '/images/inteligentOrchard.png',
    info: 'Inteligentny Sad to projekt, który powstał w odpowiedzi na potrzeby mojego znajomego. Jest to strona reklamowa systemu czujników temperatury, które można zastosować do monitorowania temperatury  min. w sadzie, na polach uprawnych czy w komorach chłodniczych.',
    live: 'https://systemczujnikowtemperatury.pl/',
    github: 'https://github.com/agatanowicka/IS'
},
{
    id: 2,
    title: 'Algorytmy',
